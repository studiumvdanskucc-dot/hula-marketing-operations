...
insert into public.metric_definitions(
  ...
  ('platform_paid_roas', 'Blended paid ROAS', '(Google Ads platform conversion value + Meta platform purchase value) / paid-media spend', 'Google Ads + Meta Ads', 'Every 4–6 hours; daily finalization', 'Paid media', 'Platforms can overlap and use different attribution windows'),
